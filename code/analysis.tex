...
(Barber 2016). Even donations from business executives have been found
to be ``best understood as purchases of \texttt{good\ will} whose
returns, while positive in expectation, are contingent and rare''
(Sanford C. Gordon 2007).

One study has suggested that \# Different:

Political parties draw their bases of electoral support from different
geographic bases. However, major campaign donors are highly concentrated
geographically. These ``big-donor neighborhoods'' are unrepresentative
of the country as a whole and point to these communities having a
distinct political culture (Brittany H. Bramlett 2011).
...
legislators in that state. And higher limits for political action
