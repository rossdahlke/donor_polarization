...
\NormalTok{           per_rep }\OperatorTok{<}\StringTok{ }\NormalTok{.}\DecValTok{25} \OperatorTok{~}\StringTok{ "democrat"}\NormalTok{,}
\NormalTok{           per_rep }\OperatorTok{>=}\StringTok{ }\NormalTok{.}\DecValTok{25} \OperatorTok{&}\StringTok{ }\NormalTok{per_rep }\OperatorTok{<=}\StringTok{ }\NormalTok{.}\DecValTok{75} \OperatorTok{~}\StringTok{ "bipartisan"}\NormalTok{,}
\NormalTok{           per_rep }\OperatorTok{>}\StringTok{ }\NormalTok{.}\DecValTok{75} \OperatorTok{~}\StringTok{ "republican"}
\NormalTok{         ))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modularity_calc <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{year =}  \StringTok{"2010"}\NormalTok{)\{}
...
\NormalTok{  year_}\DecValTok{2}\NormalTok{ =}\StringTok{ }\KeywordTok{as.character}\NormalTok{(year_}\DecValTok{2}\NormalTok{)}
  ...
  \KeywordTok{print}\NormalTok{(year_}\DecValTok{1}\NormalTok{)}
  \KeywordTok{print}\NormalTok{(year_}\DecValTok{2}\NormalTok{)}
  
\NormalTok{  bootstrap <-}\StringTok{ }\NormalTok{by_donor }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(election_year }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(year_}\DecValTok{1}\NormalTok{, year_}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\newpage
\singlespacing 
\bibliography{/Users/rossdahlke/Dropbox/master.bib}
