...
The folk-theory of political donors is of smokey backrooms and access-oriented donors who seek to have a direct influence on policy making. However, even when donors contribute to legislators that maximize their economic interests, donations are not found to be motivated by existing policy agreements and not an expectation of access [@barber2016]. Even donations from business executives have been found to be "best understood as purchases of `good will` whose returns, while positive in expectation, are contingent and rare" [@gordon2007].

One study has suggested that 
# Different:

Political parties draw their bases of electoral support from different geographic bases. However, major campaign donors are highly concentrated geographically. These "big-donor neighborhoods" are unrepresentative of the country as a whole and point to these communities having a distinct political culture [@bramlett2011].
